...
export const SCHEMA_MANIFEST: readonly TableManifest[] = [
  ...
  {
    name: 'project_writing_stats',
    columns: ['project_id', 'chapter_count', 'body_char_count', 'updated_at'],
    backup: true,
    restoreOrder: 25,
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      'result_memory_fingerprint',
      'episodic_summary_json',
      'patch_json',
      'estimated_tokens',
      'status',
      'last_error',
  ...
  },
  {
    ...
    columns: [
      ...
      'mode',
      'interval_chapters',
      'pending_token_soft_limit',
      'update_on_key_chapter',
      'updated_at',
    ],
    backup: true,
    restoreOrder: 38,
  ...
  },
  {
    ...
    indexes: ['idx_pipeline_tasks_parent_task'],
    backup: true,
    restoreOrder: 150,
  },
  {
    name: 'pipeline_stage_checkpoints',
    columns: [
      'task_id',
      'stage',
      'status',
    ...
    indexes: ['idx_pipeline_stage_checkpoints_status'],
    backup: true,
    restoreOrder: 151,
  },
  // Schema 41: durable per-attempt LLM records shared by single-chapter and
  // batch modes. Restored after checkpoints so FK (pipeline_task_id) resolves.
  {
    name: 'pipeline_stage_attempts',
    columns: [
      'id',
      'pipeline_task_id',
      'stage',
    ...
    indexes: [
      ...
      'idx_pipeline_stage_attempts_retry',
    ],
    backup: true,
    restoreOrder: 152,
  },
  {
    name: 'story_memory_request_attempts',
    columns: [
      'attempt_id',
      'logical_batch_id',
      'project_id',
    ...
    indexes: [
      'idx_story_memory_request_attempts_project',
      'idx_story_memory_request_attempts_status',
    ],
    backup: true,
    restoreOrder: 153,
  },
  ...
  },
  {
    ...
    indexes: [
      ...
      'idx_analysis_batches_next',
      'idx_analysis_batches_parent',
      'idx_analysis_batches_segment',
    ],
    backup: true,
    restoreOrder: 280,
  },
  ...
  },
  {
    ...
    indexes: ['idx_canon_evidence_range', 'idx_canon_evidence_rescan_op'],
    backup: true,
    restoreOrder: 290,
  },
  {
  ...
  },
  {
    ...
    indexes: [
      ...
      'idx_canon_world_rules_business',
    ],
    backup: true,
    restoreOrder: 310,
  },
  ...
  },
  {
    ...
    indexes: [
      ...
      'idx_canon_rel_pair',
      'idx_canon_relationships_business',
    ],
    backup: true,
    restoreOrder: 350,
  },
  {
    ...
    indexes: [
      ...
      'idx_canon_plot_threads_business',
    ],
    backup: true,
    restoreOrder: 360,
  },
  ...
  },
  {
    ...
    indexes: [
      ...
      'idx_canon_experiences_business',
    ],
    backup: true,
    restoreOrder: 380,
  },
  ...
  {
    name: 'continuation_generation_stage_results',
    columns: [
      'id',
      'run_id',
      'stage',
    ...
    indexes: ['idx_continuation_stage_results_run_state'],
    backup: true,
    // Stage results reference both runs and artifacts, so restore them after
    // artifacts but before plans/checks.
    restoreOrder: 435,
  },
  {
  ...
  },
  {
    ...
    columns: ['entity_id', 'normalized_alias', 'display_alias', 'created_at'],
    backup: true,
    restoreOrder: 480,
  },
  {
  ...
  // other project-scoped resources.
  {
    ...
    indexes: ['idx_outlines_project_position', 'idx_outlines_project_enabled'],
    backup: true,
    restoreOrder: 132,
  },
  // Schema 42 multi-chapter batch orchestration (outline mode only).
  // Parent-first: batches → items → runs. Metadata only — chapter bodies
  // live in `chapters`.
  {
    name: 'multi_chapter_batches',
    columns: [
      'id',
      'project_id',
      'status',
      ...
      'planner_request_fingerprint',
      'start_position',
      'expected_tail_chapter_id',
      'current_ordinal',
      'completed_count',
      'active_item_ordinal',
      'max_llm_calls',
    ...
    indexes: ['idx_multi_batches_project_status'],
    backup: true,
    restoreOrder: 141,
  },
  {
    name: 'multi_chapter_batch_items',
    columns: [
      'batch_id',
      'ordinal',
      'title',
    ...
    indexes: ['idx_multi_items_status', 'idx_multi_items_retry'],
    backup: true,
    // After batches (parent) and after chapters (chapter_id FK) but before
    // pipeline task heavy rows; 152+ keeps them after pipeline tables.
    restoreOrder: 153,
  },
  {
    name: 'multi_chapter_batch_item_runs',
    columns: [
      'batch_id',
      'ordinal',
      'run_no',
    ...
    backup: true,
    // After items (composite FK) and after pipeline_tasks (FK).
    restoreOrder: 154,
  },
];
