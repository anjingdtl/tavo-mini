...
import { listHistoricalDigestReferences } from '../../continuation/canon/historicalDigestService';
import {
  getInjectableStyleProfile,
  type StyleProfileFingerprint,
  type ContinuationStyleProfileRow,
} from '../../continuation/styleProfile/styleProfileRepository';
import {
...
import { computeStyleProfileHash } from '../../continuation/styleProfile/styleProfileHash';
import { STYLE_ANALYZER_VERSION } from '../../continuation/styleProfile/styleAnalysisPrompt';
import type { StyleMetrics } from '../../continuation/styleProfile/styleStatistics';
import { CONTINUATION_BUDGET_POLICY } from './continuationStageCapacity';
import {
...
import { buildContinuationSupplementContext } from '../../continuation/generation/continuationSupplementContextBuilder';
import {
  contentRevisionHash,
...
} from './continuationStageCapacity';
import {
  selectContinuationAnchor,
  type ContinuationAnchorChapter,
} from '../../continuation/generation/continuationAnchor';
import {
  planContinuationV4ContextBudget,
  resolveContinuationV4BudgetPreview,
} from '../../continuation/generation/continuationV4Budget';
import {
  buildContinuationV4StageViews,
  hashContinuationV4StageView,
} from '../../continuation/generation/continuationV4ContextViews';
import {
...
} from '../../continuation/generation/continuationV4PromptCompiler';
import {
  buildContinuationControlFallback,
  buildContinuationControlMetrics,
} from '../../continuation/generation/continuationControl';
...
function requiredCapabilities(
  profile: StrictnessProfile,
): Array<keyof import('../../continuation/canon/types').CanonCapabilities> {
  if (profile === 'loose') {
...
function capabilityGaps(
  caps: import('../../continuation/canon/types').CanonCapabilities,
  profile: StrictnessProfile,
): string[] {
...
function fingerprintFromSource(
  source: import('../../continuation/types').ContinuationSourceSnapshot,
