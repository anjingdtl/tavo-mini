 ...
 * compatibility only.
 *
 * The V5 stage machinery (round functions, stage ledger, error finalizer,
 * contracts re-exports) lives in
 * src/services/writing/execution/continuationV5StageMachine.ts. This module
...
} from '../../writing/execution/continuationV5StageMachine';
import {
  casUpdateRunState,
...
// Named re-exports from the stage machine for test compatibility (parse/
// hash helpers, length policy, the stage-caller test hook and the pipeline
// options type). Production code imports these from the machine or from
...
export type { V5PipelineOptions } from '../../writing/execution/continuationV5StageMachine';
