...
- 证据索引：[`phase4-iv13u-final-evidence-20260901.json`](evidence/phase4-iv13u-final-evidence-20260901.json)，SHA-256=`F2F41CDA2A557431070A5EB975FC18C53C117A0C7D2FF68825DDAF678CE563E9`。该提交物只索引标量/哈希证据，不包含 SQLite、正文、Prompt 或 model thinking text。

### 5.2 V2.30.0 正式发版验收

- 规范版本：`2.30.0`；展示版本：`V2.30.0`；`versionCode=2300000`。
- 发版提交：`e9c7f7dc311eb7ae241aa35cc02c5061651b6341`（`chore: release v2.30.0`）。
...
- 更新后的 body-free 证据索引：[`phase4-iv13u-final-evidence-20260901.json`](evidence/phase4-iv13u-final-evidence-20260901.json)，SHA-256=`F2F41CDA2A557431070A5EB975FC18C53C117A0C7D2FF68825DDAF678CE563E9`；只包含标量、路径和 SHA-256，不包含 SQLite、正文、Prompt 或 reasoning。
