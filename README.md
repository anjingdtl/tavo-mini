...
[![Version](https://img.shields.io/badge/Version-V2.5.24-blue.svg)](CHANGELOG.md)
...
当前版本：**V2.5.24** · 数据库 Schema：**18** · 最低 Android API：**24**

`V2.5.24` 修正新项目世界书的子条目启用路径：当用户新增或单独开启世界书条目时，系统会自动启用其所属项目合集，避免界面显示“当前项目使用”但写作上下文仍被父合集过滤。详见 [CHANGELOG](CHANGELOG.md)。
...
目标正式产物：`dist/apk/release/ShineWriter-V2.5.24-release.apk`，`versionName=V2.5.24`，`versionCode=2052400`。
