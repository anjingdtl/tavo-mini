...
[![Version](https://img.shields.io/badge/Version-V2.11.16-blue.svg)](CHANGELOG.md)

</div>

当前版本：**V2.11.16** · 支持 Android 7.0 及以上设备
...
如果你已经有完整原著，也可以创建“原著续写”项目：导入原著、设置续写边界、完成 Canon 分析后，再从边界之后继续写新的章节。本地数据库当前为 **Schema 33**。
...
正式 APK 文件：`dist/apk/release/ShineWriter-V2.11.16-release.apk`

构建标识：`versionName=V2.11.16`，`versionCode=2111600`。
...
The current version is **V2.11.16**. ShineWriter is an Android-first writing workspace. It supports outline writing, Canon-driven continuation, optional online AI, backups, and text-to-speech.
