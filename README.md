...
[![Version](https://img.shields.io/badge/Version-V2.6.2-blue.svg)](CHANGELOG.md)
...
当前版本：**V2.6.2** · 数据库 Schema：**18** · 最低 Android API：**24**

`V2.6.2` 修复世界书在写作流水线中“开了却不进上下文”：空章/无关键词命中时对项目已启用世界书兜底注入；导入时完整保留全部主触发词；生成指令参与扫描；新建合集同步项目级开关。详见 [CHANGELOG](CHANGELOG.md)。
...
目标正式产物：`dist/apk/release/ShineWriter-V2.6.2-release.apk`，`versionName=V2.6.2`，`versionCode=2060200`。
...
| versionName / versionCode | V2.6.2 / 2060200 |
