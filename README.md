...
| versionName / versionCode | V2.9.1 / 2090100 |
| 文件大小 | 38,047,431 bytes（36.28 MB） |
| APK SHA-256 | `453E339E957509D9A06CC9015BB9D0E2709C1D8EB4D6ECA14A0FB02D6C486605` |
| Android API 37 冷启动 | 真实 Release 安装并进入项目首页；系统仍提示已知 16 KB native library 兼容警告 |
