...
[![Version](https://img.shields.io/badge/Version-V2.11.46-blue.svg)](CHANGELOG.md)

</div>

当前版本：**V2.11.46** · 支持 Android 7.0 及以上设备
...
正式 APK 文件：`dist/apk/release/ShineWriter-V2.11.46-release.apk`

构建标识：`versionName=V2.11.46`，`versionCode=2114600`。
...
The current version is **V2.11.46**. ShineWriter is an Android-first writing workspace. It supports outline writing, Canon-driven continuation, optional online AI, backups, and text-to-speech.
