...
目标正式产物：`dist/apk/release/ShineWriter-V2.8.0-release.apk`，`versionName=V2.8.0`，`versionCode=2080000`。
...
| versionName / versionCode | V2.8.0 / 2080000 |
