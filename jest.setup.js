...
jest.mock('react-native', () => {
  ...
  RN.NativeModules.AppUpdate = {
    ...
    getUpdateDownloadStatus: jest.fn(() => Promise.resolve(null)),
    cancelUpdateDownload: jest.fn(() => Promise.resolve(true)),
    materializeDownloadedUpdate: jest.fn(() =>
      Promise.resolve('/tmp/cache/updates/ShineWriter-V3.0.1-release.apk'),
    ),
