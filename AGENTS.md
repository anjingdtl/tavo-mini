...
主要表（约 30 张）：projects、chapters、fragments、plotlines、project_plotlines、characters、character_collections、worldbook_collections、worldbook_entries、notes、project_note_config、note_style_profiles、presets、llm_config、local_llm_models、settings、project_resources、llm_usage_logs、pipeline_tasks、pipeline_stage_checkpoints、freeform_documents、content_revisions、generation_drafts、outlines，以及续写/Canon/时间线/story-memory 等领域表（详见 `createCurrentSchema.ts` 与各 `vN-to-vN+1.ts`）。
